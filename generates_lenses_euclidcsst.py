...
# generates gravitational lensing images and saves them as TFRecord files using multiprocessing
# uses configurations from Euclid and CSST lensing simulations
...
DELTA_PIX_EUCLIDE = main_config.getfloat('INSTRUMENTS', 'delta_euclid')
DELTA_PIX_CSST = main_config.getfloat('INSTRUMENTS', 'delta_csst')
DELTA_PIX_HR = 0.01  # High-resolution delta pixel for internal calculations
